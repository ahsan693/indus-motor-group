...
export default function Details() {
	...
	if (!carId) {
		return (
			<div className="min-h-screen bg-black text-zinc-300">
				<Navbar />
				<main className="mx-auto max-w-[1240px] space-y-8 px-5 py-10 md:px-8 md:py-14">
	...
	return (
		<div className="min-h-screen bg-black text-zinc-300">
											...
											<div className="space-y-3 p-4">
												...
												<div className="flex flex-wrap gap-1.5">
													{getRelatedTags(relatedCar).map((tag) => (
														<span key={`${relatedCar._id}-${tag}`} className="rounded-full border border-zinc-700 bg-zinc-950 px-2 py-1 text-[10px] text-zinc-300">
															{tag}
														</span>
													))}
												</div>
			...
			<section className="mx-auto mt-14 w-full max-w-[1240px] px-5 md:mt-16 md:px-8">
